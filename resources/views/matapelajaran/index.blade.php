        ...
        <div class="col-md-6">
            <div class="input-group">
                ...
                <input type="text" name="q" value="{{ $q }}" class="form-control"
                    placeholder="Cari nama mata pelajaran" id="mpSearchInput" autocomplete="off">
            </div>
        </div>
        <div class="col-md-4">
            <select name="tahun" class="form-select" onchange="this.form.submit()">
                ...
                @foreach ($tahunAjaran as $t)
                    <option value="{{ $t->id_tahunAjaran }}"
                        {{ (string) $tahunId === (string) $t->id_tahunAjaran ? 'selected' : '' }}>
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="nama_matapelajaran"
                                    ...
                                    value="{{ old('nama_matapelajaran') }}" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="bobot_UTS" class="form-control bobot-input" min="0"
                                    max="100" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bobot UAS</label>
                                <input type="number" name="bobot_UAS" class="form-control bobot-input" min="0"
                                    max="100" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bobot Praktik</label>
                                <input type="number" name="bobot_praktik" class="form-control bobot-input"
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-8">
                                <label class="form-label">Nama Mata Pelajaran</label>
                                <input type="text" name="nama_matapelajaran" id="edit_nama"
                                    class="form-control @error('nama_matapelajaran') is-invalid @enderror" required>
                                @error('nama_matapelajaran')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                <label class="form-label">Bobot UTS</label>
                                <input type="number" name="bobot_UTS" id="edit_uts"
                                    class="form-control bobot-input-edit" min="0" max="100" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bobot UAS</label>
                                <input type="number" name="bobot_UAS" id="edit_uas"
                                    class="form-control bobot-input-edit" min="0" max="100" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bobot Praktik</label>
                                <input type="number" name="bobot_praktik" id="edit_praktik"
                                    class="form-control bobot-input-edit" min="0" max="100" required>
                            </div>
                            <div class="col-12">
                                <div class="alert alert-info mb-0">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8" id="v_id"></dd>
                        <dt class="col-sm-4">Nama</dt>
                        <dd class="col-sm-8" id="v_nama"></dd>
                        <dt class="col-sm-4">Kelas</dt>
                        <dd class="col-sm-8" id="v_kelas"></dd>
                        <dt class="col-sm-4">Materi</dt>
                        <dd class="col-sm-8" id="v_materi"></dd>
                        <dt class="col-sm-4">Tahun Ajaran</dt>
                        <dd class="col-sm-8" id="v_tahun"></dd>
                        <dt class="col-sm-4">Pendidik</dt>
                        <dd class="col-sm-8" id="v_pendidik"></dd>
                        <dt class="col-sm-4">KKM</dt>
                        <dd class="col-sm-8" id="v_kkm"></dd>
                        <dt class="col-sm-4">Bobot UTS</dt>
                        <dd class="col-sm-8" id="v_uts"></dd>
                        <dt class="col-sm-4">Bobot UAS</dt>
                        <dd class="col-sm-8" id="v_uas"></dd>
                        <dt class="col-sm-4">Bobot Praktik</dt>
                        <dd class="col-sm-8" id="v_praktik"></dd>
                    </dl>
                </div>
                <div class="modal-footer">
